 ...
 * @author Yan
 */
public class HibernatePregnancyDAO implements PregnancyDAO {
    ...
    public Pregnancy getPregnancy(Integer id) {
        return (Pregnancy) sessionFactory.getCurrentSession().get(Pregnancy.class, id);
    }

    public Pregnancy savePregnancy(Pregnancy pregnancy) {
        sessionFactory.getCurrentSession().saveOrUpdate(pregnancy);
        return pregnancy;
    }    
