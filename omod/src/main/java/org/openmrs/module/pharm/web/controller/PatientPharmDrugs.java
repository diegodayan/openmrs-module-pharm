 ...
 */
@Controller
public class PatientPharmDrugs implements org.springframework.web.servlet.mvc.Controller {
    ...
    public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        return new ModelAndView("/module/pharm/portlets/patientPharmDrugs", map);
    }
    ...
    protected void populateModel(HttpServletRequest request, Map<String, Object> model) {
        ...
        List<PharmDrug> pharmDrugs = Context.getService(PharmDrugService.class).getPharmDrugsByPatient(patient);
        model.put("pharmDrugs", pharmDrugs);
    }
    ...
    public void showPharmDrugs(ModelMap model,
